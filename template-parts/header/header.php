...
<div id="page" class="site">
	...
	<div class="site-content<?php echo esc_attr( ( $header_layout === '7' ) ? ' site-right': ''); ?>">
		...
		if ( class_exists( 'WooCommerce' ) ) {
			$class = ( (!is_single() && !is_shop()  && ! is_home() && !is_cart() && !is_product() && !is_product_category() && !is_product_tag() &&  !is_account_page() &&  !is_checkout() || $header_layout === '7' )  ) ? 'content-page': 'page-content';
		} else {
			$class = ( ( !is_single() && ! is_home() || $header_layout === '7' )  ) ? 'content-page': 'page-content';
		}
		?>
		<div id="content" class="<?php echo esc_attr( $class); ?>">
			<div class="container leadcon-container">
